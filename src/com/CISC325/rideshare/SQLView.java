...
public class SQLView extends Activity {
	...
	protected void sendEmail(){
		...
		try {
		    ...
		    Toast.makeText(SQLView.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
		}
	}
	//to here
	...
	public void onBackPressed() {
		Intent i = new Intent(SQLView.this, SearchAdd.class);
		SQLView.this.startActivity(i);
		finish();
	}
